...
def parse_args():
    ...
    parser.add_argument('--config',default='/opt/data/private/Syg/BS/code/11.28/work_dirs/mask2former_uniperceiver_adapter_large_512_40k_ade20k_ss_new2/mask2former_uniperceiver_adapter_large_512_40k_ade20k_ss_new2.py' ,help='test config file path')
    parser.add_argument('--checkpoint',default='/opt/data/private/Syg/BS/code/11.28/work_dirs/mask2former_uniperceiver_adapter_large_512_40k_ade20k_ss_new2/iter_38000.pth', help='checkpoint file')
    parser.add_argument(
