...
from .WEFT_module2_1 import EdgeAwareCrossTokenRefine
from .WEFT_module2_2 import TokenEnhancerWeighted
...
class Local_priors_eh(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None,
        ...
        self.dwconv = TokenEnhancerWeighted(hidden_features)
        self.act = act_layer()
...
class Module2_2_only_1(nn.Module):
    def __init__(self, dim, num_heads=6, n_points=4, n_levels=1, deform_ratio=1.0,
        ...
        self.ffn = Local_priors_eh(in_features=dim, hidden_features=int(dim * cffn_ratio), drop=drop)
...
class Module2_1(nn.Module):
    def __init__(self, dim, num_heads=6, n_points=4, n_levels=1, deform_ratio=1.0,
        ...
        self.edgecross = EdgeAwareCrossTokenRefine()
    ...
    def forward(self, query, reference_points, feat, spatial_shapes, level_start_index):
        ...
        def _inner_forward(query, feat):
            ...
            return query + self.gamma * self.edgecross(attn)
...
class Module2(nn.Module):
    def __init__(self, dim, num_heads=6, n_points=4, norm_layer=partial(nn.LayerNorm, eps=1e-6),
        ...
        self.module2_1 = Module2_1(dim=dim, n_levels=3, num_heads=num_heads, init_values=init_values,
                                 ...
                                 with_cp=with_cp)
        self.module2_2 = Module2_2_only_1(dim=dim, n_levels=1, num_heads=num_heads, n_points=n_points,
                                   norm_layer=norm_layer, deform_ratio=deform_ratio, with_cffn=with_cffn,
                                   cffn_ratio=cffn_ratio, drop=drop, drop_path=drop_path, with_cp=with_cp)
        if extra_extractor:
            self.extra_extractors = nn.Sequential(*[
                Module2_2_only_1(dim=dim, num_heads=num_heads, n_points=n_points, norm_layer=norm_layer,
