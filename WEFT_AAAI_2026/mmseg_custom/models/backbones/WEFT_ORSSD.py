...
from .WEFT_module1 import Module1
from .WEFT_module2 import Module2, deform_inputs

_logger = logging.getLogger(__name__)


@BACKBONES.register_module()
class WEFT_ORSSD(UnifiedBertEncoder):
    ...
    def forward(self, x):
        ...
        c2_up = F.interpolate(c2, scale_factor=2, mode='bilinear', align_corners=False)
        c1 = c2_up + c1
